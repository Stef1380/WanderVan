...
puts "user ok"
Van.create(user: User.first, brand: "VW California", km: "39800", description: "van authentique pour les baroudeurs", number_of_seat: "4", price: "145", categorie: "LoveRoom", location: "bordeaux")
Van.create(user: User.first, brand: "Peugeot Partner", km: "43566", description: "tout confort", number_of_seat: "5", price: "79", categorie: "Pets", location: "Lyon")
Van.create(user: User.first, brand: "VW California", km: "2567", description: " version moderne", number_of_seat: "4", price: "109", categorie: "Romantique", location: "Paris")
...
Van.create(user: User.first, brand: "Peugeot Partner", km: "43566", description: "tout confort", number_of_seat: "5", price: "79", categorie: "Famille", location: "Lyon")
Van.create(user: User.first, brand: "VW California", km: "2567", description: " version moderne", number_of_seat: "4", price: "109", categorie: "Pets", location: "Paris")
Van.create(user: User.first, brand: "VW transport", km: "78999", description: "espace et confort", number_of_seat: "5", price: "69", categorie: "Adventure", location: "Montpellier")
Van.create(user: User.first, brand: "VW California", km: "39800", description: "van authentique pour les baroudeurs", number_of_seat: "4", price: "Famille", categorie: "fun", location: "bordeaux")
Van.create(user: User.first, brand: "Peugeot Partner", km: "43566", description: "tout confort", number_of_seat: "5", price: "79", categorie: "Adventure", location: "Lyon")
Van.create(user: User.first, brand: "VW California", km: "2567", description: " version moderne", number_of_seat: "4", price: "109", categorie: "Romantique", location: "Paris")
